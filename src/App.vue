...
// ⚠️ Troque as URLs abaixo pelas redes reais do VisionFade — essas são
// só exemplos. O "rotulo" é o texto que aparece embaixo no hover, e a "cor"
// é a cor oficial da marca, aplicada quando o cursor passa por cima.
//
// O desenho de cada ícone (viewBox + path) vem embutido aqui, em vez de vir
// de um arquivo .svg importado. Assim o ícone é um <svg> de verdade dentro
// da página, e a cor dele obedece ao CSS normalmente — sem máscara, sem URL
// e sem depender da importação de arquivo.
const redesSociais = [
  {
    nome: 'Instagram',
    url: 'https://instagram.com/visionfade',
    rotulo: 'instagram.com/visionfade',
    cor: '#e4405f',
    viewBox: '0 0 448 512',
  ...
  {
    nome: 'WhatsApp',
    url: 'https://wa.me/5517999999999',
    rotulo: 'wa.me/5517999999999',
    cor: '#25d366',
    viewBox: '0 0 448 512',
  ...
  {
    nome: 'Facebook',
    url: 'https://facebook.com/visionfade',
    rotulo: 'facebook.com/visionfade',
    cor: '#1877f2',
    viewBox: '0 0 512 512',
...
<template>
  <aside class="sidebar" :class="{ 'sidebar-open': menuAberto }">
    ...
    <nav class="sidebar-nav">
      <RouterLink v-if="estadoUsuario.nivelAcesso !== 'cliente'" to="/gerar-3d" class="sidebar-link" active-class="sidebar-link-active" @click="fecharMenu">Gerar 3D</RouterLink>
      ...
      <RouterLink v-if="estadoUsuario.login" to="/configuracoes" class="sidebar-link" active-class="sidebar-link-active" @click="fecharMenu">Configurações</RouterLink>
    </nav>

    <div class="sidebar-social">
      <p class="sidebar-social-title">Entre em contato</p>
      ...
      <div class="sidebar-social-icons">
        ...
        >
          <svg
            ...
            :style="{ '--cor-marca': rede.cor }"
            fill="currentColor"
            aria-hidden="true"
          >
            <path :d="rede.path" />
          </svg>
          <span class="sidebar-social-url">{{ rede.rotulo }}</span>
        </a>
      </div>
    </div>
  </aside>
